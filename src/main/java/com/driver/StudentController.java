...
public class StudentController {
    ...
    public ResponseEntity<String> addTeacher(@RequestBody com.driver.Teacher teacher) {
    ...
    public ResponseEntity<com.driver.Student> getStudentByName(@PathVariable String name) {
        com.driver.Student student = studentService.findStudent(name);
    ...
    public ResponseEntity<String> getStudentsByTeacherName(@PathVariable String teacher) {
